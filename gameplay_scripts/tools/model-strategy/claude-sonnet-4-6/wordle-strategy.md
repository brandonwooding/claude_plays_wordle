...
- **When 2–3 candidates remain, list them all explicitly and pick the most commonly used English word among them.** Do not default to whichever candidate came to mind first — a moment of enumeration can surface a higher-frequency word and slightly improve your odds of solving in the fewest guesses.
...
- **Re-enumerate candidates after every guess from guess 2 onwards** (not just after guesses 1–2). When 10+ letters are eliminated and positional constraints are tight, the candidate pool can collapse to 2–4 words by guess 3 — catch this early rather than spending another guess on positional probing
